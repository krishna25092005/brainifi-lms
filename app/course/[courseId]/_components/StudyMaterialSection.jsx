...
function StudyMaterialSection({ courseId, course }) {
  ...
  if (loading) {
    return <div className="text-gray-800 dark:text-gray-200 font-medium">Loading study materials...</div>;
  }

  if (error) {
    return <div className="text-red-600 dark:text-red-400 font-medium">{error}</div>;
  }
